...
const themeToggle = document.getElementById('themeToggle'); // نفس الـ id اللي استخدمتيه
const setThemeIcon = () => {
...
if (themeToggle) {
  // أول تحميل
  setThemeIcon();
  // عند الضغط (لو عندك مستمع جاهز للتبديل خلّي آخره يستدعي setThemeIcon)
  themeToggle.addEventListener('click', setThemeIcon);
}
